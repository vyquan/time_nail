...
export const changePassWord = (changePass) => async (dispatch) => {
    try {
       await authAPI.changePassword(changePass)     
        .then(response => {
             if(response.data.error) {
                 dispatch({
...
export const changePassWordStaff = (changePassStaff) => async (dispatch) => {
     try {
         await authAPI.changePassWordStaff(changePassStaff)
         .then(response => {
             if(response.data.error) {
                dispatch({
...
export const resetPasswordChangePass = (resetPass) => async (dispatch) => {   
        try {
         await axios.post(`http://localhost:8000/api/reset-password`, resetPass)
         .then(response => {
            dispatch({
