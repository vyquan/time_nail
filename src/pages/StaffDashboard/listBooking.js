              ...
              <TabPane tab="Lịch đặt hôm nay" key="1">
                          ...
                          {curentPosts &&
                            curentPosts.map((item) => (
                              <tr key={item.id}>
                                ...
                                <td>Tẩy lông chân tay</td>
                                <td>Combo sơn móng tay mịn rất phù hợp với túi tiền</td>
                                <td>
                                  {(() => {
                ...
                {historyBook.today && historyBook.today.length > 0 ? (
                  <div className="container">
                    <div className="row">
                      <div
                        className="col-lg-6 col-md-6 col-sm-12 col-12 mt-3 show-left"
                                          ...
                                          <div className="card-body">
                                            ...
                                            <div className="d-flex justify-content-between pt-3">
                                              <ul className="list-items list-items-2 flex-grow-1">
                                                <li>
                                                  <span>Tổng thời gian:</span>
                                                  {datafuture.total_time_execution} phút
                                                </li>
                                                <li>
                                                  <span>Số lượng người:</span>
                                                  {datafuture.total_people} người
                                                </li>
                                                <li>
                                                  <span>Giá:</span>
                                                  {datafuture.total_bill?.toLocaleString('it-IT', {
                                                    style: 'currency',
                                                    currency: 'VND',
                                                  })}
                                                </li>
                                                ...
                                                <li>
                                                  <span>Mã giảm giá:</span>
                                                  <a href="#">{datafuture.code_discount}</a>
                                                </li>
                                                <li>
                                                  <span>Mã hóa đơn:</span>
                                                  <a href="#">{datafuture.code_bill}</a>
                                                </li>
                                              </ul>
                                            </div>
                                          </div>
